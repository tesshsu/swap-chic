<div class="end">
    ...
    <a href="<?php echo 'https://'.$_SERVER['HTTP_HOST'].'/inviter-amies/' ?>" class="btn add-member">Invite tes amies</a>
    <a href="<?php echo 'https://'.$_SERVER['HTTP_HOST'].'/proposer-swap-place/' ?>" class="btn add-swapplace">Propose une swap-place</a>
</div>